(function (app) {
    ...
    app.controller('applicationgroupViewController', applicationgroupViewController);

    applicationgroupViewController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];

    function applicationgroupViewController($scope, apiService, notificationService, $ngBootbox, $filter) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 1;
        $scope.pageCount = 0;
